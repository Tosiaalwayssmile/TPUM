...
{
    public class VariableType_Phone_683592124_0 : CodeGenVariableTypeBase
    {
        public VariableType_Phone_683592124_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_Phone_683592124_0::Initialize");
            ...
            this.GetNode().BrowseName  = "Phone";
            this.GetNode().DisplayName = "Phone";
