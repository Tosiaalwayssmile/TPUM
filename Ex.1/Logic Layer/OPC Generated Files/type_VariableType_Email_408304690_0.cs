...
{
    public class VariableType_Email_408304690_0 : CodeGenVariableTypeBase
    {
        public VariableType_Email_408304690_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_Email_408304690_0::Initialize");
            ...
            this.GetNode().BrowseName  = "Email";
            this.GetNode().DisplayName = "Email";
