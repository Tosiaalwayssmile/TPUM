...
{
    public class ObjectType_Cart_2080971199_0 : CodeGenObjectTypeBase
    {        
        public ObjectType_Cart_2080971199_0(string browseName,
        ...
        {
            Console.WriteLine("ObjectType_Cart_2080971199_0::Initialize");
    ...
    string childFileNoExtension = "type_ObjectType_User_381371170_0";
    string childSourceId = "User";
    ...
    obj_User_381371170_0 = (ObjectType_User_381371170_0)                                                                                              
    ...
    ObjectType_User_381371170_0 local = obj_User_381371170_0;
    ...
    string childFileNoExtension = "type_ObjectType_Books_931462474_0";
    string childSourceId = "Books";
    ushort childSourceNamespaceIndex =  (ushort)m_addressSpaceMgr.SystemContext.NamespaceUris.GetIndex("TPUM");
    ushort childSourceNodeIdType = 1;
    NodeId newChildId = Helper.CreateID(childrenIDMap, m_addressSpaceMgr,
                                        childSourceId, childSourceNamespaceIndex, (IdType)childSourceNodeIdType);

    string childTypeDefId = "Books";
    int childTypeDefNamespaceIndex =  m_addressSpaceMgr.SystemContext.NamespaceUris.GetIndex("TPUM");
    ushort childTypeDefNodeIdType = 1;

    obj_Books_931462474_0 = (ObjectType_Books_931462474_0)                                                                                              
            (m_addressSpaceMgr.CreateObject(childrenIDMap,                                                              
                 this.GetNode(), childFileNoExtension, childBrowseName,                                                 
                 childSourceId, childSourceNamespaceIndex, (IdType)childSourceNodeIdType,             
	                newChildId.Identifier.ToString(), newChildId.NamespaceIndex, (IdType)newChildId.IdType, 
  	            m_nodeId, m_namespaceIndex, m_nodeIdType));                                                            
    ObjectType_Books_931462474_0 local = obj_Books_931462474_0;
    m_addressSpaceMgr.AddPredefinedNodeExt(m_addressSpaceMgr.SystemContext, local.GetNode());
    ...
    string childFileNoExtension = "type_VariableType_Guid_1985059078_0";
    ...
    string childSourceId = "Guid";
    ushort childSourceNamespaceIndex = (ushort)m_addressSpaceMgr.SystemContext.NamespaceUris.GetIndex("TPUM");
    ushort childSourceNodeIdType = 1;
    NodeId newChildId = Helper.CreateID(childrenIDMap, m_addressSpaceMgr,
                                        childSourceId, childSourceNamespaceIndex, (IdType)childSourceNodeIdType);

    var_Guid_1985059078_0 = (VariableType_Guid_1985059078_0)                                                                                            
    ...
    VariableType_Guid_1985059078_0 local = var_Guid_1985059078_0;
    m_addressSpaceMgr.AddPredefinedNodeExt(m_addressSpaceMgr.SystemContext, local.GetNode());
        ...
        /* Children objects */  
            public ObjectType_User_381371170_0 obj_User_381371170_0;
    public ObjectType_Books_931462474_0 obj_Books_931462474_0;


            /* Children variables */
            public VariableType_Guid_1985059078_0 var_Guid_1985059078_0;
