...
{
    public class VariableType_Guid_1985059078_0 : CodeGenVariableTypeBase
    {
        public VariableType_Guid_1985059078_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_Guid_1985059078_0::Initialize");
            ...
            this.GetNode().BrowseName  = "Guid";
            this.GetNode().DisplayName = "Guid";
