...
{
    public class ObjectType_Books_1752425740_0 : CodeGenObjectTypeBase
    {        
        public ObjectType_Books_1752425740_0(string browseName,
        ...
        {
            Console.WriteLine("ObjectType_Books_1752425740_0::Initialize");
            ...
            // Set attributes
            this.GetNode().BrowseName  = "Books";
            this.GetNode().DisplayName = "Books";
