...
{
    public class VariableType_Amount_1461953059_0 : CodeGenVariableTypeBase
    {
        public VariableType_Amount_1461953059_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_Amount_1461953059_0::Initialize");
            ...
            this.GetNode().BrowseName  = "Amount";
            this.GetNode().DisplayName = "Amount";
            ...
            string defaultValueType = "Decimal";
            if (setDefaultValue)
            {
                try
                {
