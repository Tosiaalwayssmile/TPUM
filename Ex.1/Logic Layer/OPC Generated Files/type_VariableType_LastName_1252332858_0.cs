...
{
    public class VariableType_LastName_1252332858_0 : CodeGenVariableTypeBase
    {
        public VariableType_LastName_1252332858_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_LastName_1252332858_0::Initialize");
            ...
            this.GetNode().BrowseName  = "LastName";
            this.GetNode().DisplayName = "LastName";
