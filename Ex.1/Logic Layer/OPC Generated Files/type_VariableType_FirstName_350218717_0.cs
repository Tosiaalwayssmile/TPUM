...
{
    public class VariableType_FirstName_350218717_0 : CodeGenVariableTypeBase
    {
        public VariableType_FirstName_350218717_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_FirstName_350218717_0::Initialize");
            ...
            this.GetNode().BrowseName  = "FirstName";
            this.GetNode().DisplayName = "FirstName";
